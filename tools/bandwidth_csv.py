...
def main():
    ...
    if args.os_username:
        insecure = urlparse(args.os_auth_url).scheme != 'https'

        keystone = ksclient.Client(username=args.os_username,
        ...
        ceilometer = ceilometerclient.Client(base_url=args.base_url)
